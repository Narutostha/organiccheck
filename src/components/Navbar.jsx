...
const Navbar = () => {
  ...
  return (
    <nav className="bg-grey z-10 shadow-sm py-1 mx-auto ">
      
        <div className="flex h-16 items-center space-x-4 md:justify-between">
          ...
          <div className="flex items-center gap-5">
            ...
            >
              <FiShoppingCart className="text-2xl text-darkGreen cursor-pointer" />
            ...
            <div className=" bg-darkGreen hidden md:flex h-8 w-8 rounded-full items-center justify-center">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4">
            <div className="flex flex-col space-y-4">
              <div className=" bg-darkGreen flex mx-4 my-2  h-8 w-8 rounded-full items-center justify-center">
                <IoPersonSharp className="text-grey text-lg" />
              </div>
              {navLinks.map((link) => (
                <a
